...
\begin{itemize}[nosep]
    ...
    \item \textbf{EST} (fraud ID detection) : $\sim$41\,800 images de pièces d'identité réparties en 7 classes (1 classe positive + 6 types de fraude). Extension du projet à la \emph{vision}.
\end{itemize}
